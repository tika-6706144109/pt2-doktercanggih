 ...
 */
public class ConsulAnsweredFragment extends Fragment implements ConsulAdapter.AdapterListener {
    ...
    private void callApiConsult(String doctor_id){
        ConsulApi.callApiConsulAnswer(getActivity(), doctor_id, consultAllListener);
    }
}
