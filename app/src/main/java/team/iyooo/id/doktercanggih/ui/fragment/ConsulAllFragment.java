 ...
 */
public class ConsulAllFragment extends Fragment implements ConsulAdapter.AdapterListener{
    ...
    private void callApiConsult(){
        ConsulApi.callApiListConsul(getActivity(), consultAllListener);
    }
}
